...
experiments_IDs_b = [1,6,1212] # Not scaled
...
def validation_loop(methodID_string, experiment_IDs_collection, ModelSet, 
 path_to_results = './' ):
    for experiment_number in experiment_IDs_collection:
        ...
        plt.close()
# %% training loop
# experiment_loop('SAGE_RF2', experiments_IDs_0, SAGE0, num_epochs = 500, path_to_results = pathRes)
experiment_loop('SAGE_RF2', experiments_IDs_b, SAGE0, num_epochs = 500, path_to_results = pathRes)
validation_loop('SAGE_RF2', experiments_IDs_0, SAGE0, path_to_results = pathRes)
experiment_loop('GCN_RF2',  experiments_IDs_0, GCN0, num_epochs = 500 , path_to_results = pathRes)
