...
# methodID_string = 'LR_RF3'
# MODEL = LR0
# methodID_string = 'FN_RF3'
# MODEL = SimpleNet
# methodID_string = 'GCN_RF3'
# MODEL = GCN0
# methodID_string = 'SAGE_RF3'
# MODEL = SAGE0
GT = ground_truth.GroundTruth()
GT.fibonacci(vtu_file   = GFDS.gfds_name + '_' + methodID_string + '_01.vtu')
# %%
