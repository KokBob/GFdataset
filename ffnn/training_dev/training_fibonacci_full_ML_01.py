...
def validation_loop(methodID_string, experiment_IDs_collection, ModelSet, path_to_results = './' ):
    for experiment_number in experiment_IDs_collection:
        ...
        plt.close()
# # %% training loop
experiment_loop('LR_RF3', experiments_IDs_0, LR0, num_epochs = numEpochs, path_to_results = pathRes)
validation_loop('LR_RF3', experiments_IDs_0, LR0, path_to_results = pathRes)
experiment_loop('FN_RF3', experiments_IDs_0, SimpleNet, num_epochs = numEpochs , path_to_results = pathRes)
validation_loop('FN_RF3', experiments_IDs_0, SimpleNet, path_to_results = pathRes)