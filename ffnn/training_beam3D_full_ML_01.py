...
def experiment_loop(methodID_string, experiment_IDs_collection, ModelSet, 
    ...
    for experiment_number in experiment_IDs_collection:
        ...
        break
# %% test variables and prompts delete after testing
...
def validation_loop(methodID_string, experiment_IDs_collection, ModelSet, path_to_results = './' ):
    for experiment_number in experiment_IDs_collection:
        ...
        plt.close()
# # %% training loop
experiment_loop('LR_RF2', experiments_IDs_0, LR0, num_epochs = 10, path_to_results = pathRes)
experiment_loop('FN_RF2', experiments_IDs_0, SimpleNet, num_epochs = 10 , path_to_results = pathRes)
